...
const stylings = {
  ...
  menuIcon:'block md:hidden text-[#FFC2C2] h-8 w-8',
  ...
  menublock:'h-screen w-screen flex flex-col justify-center align-center bg-[#010A43] absolute right-0 top-0 ',
  mobileItemBlock:'flex justify-center align-center flex-col text-right',
  menuExitIcon:'text-[#ED2B2A] w-[50px] h-[40px] absolute top-11 right-4 z-20',
  mobileItems:'flex justify-center align-center font-reading text-[#FFC2C2] text-[45px] gap-2 mt-4',
  }